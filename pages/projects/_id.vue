			...
			<div class="projectx__flex">
				...
				<div class="projectx__white">
					...
					<div class="white__tabnames">
						...
						<div class="white__tabname" v-bind:class="{ active: activeTab===2 }" v-on:click="chageTab(2)">Инструменты</div>
						<div class="white__tabname" v-bind:class="{ active: activeTab===3 }" v-on:click="chageTab(3)">Люди</div>
						<div class="white__tabname" v-bind:class="{ active: activeTab===4 }" v-on:click="chageTab(4)">Транспорт</div>
					</div>
					<div class="white__tabs">
						<div class="white__tab" v-bind:class="{ active: activeTab===1 }">
							<div class="white__row">
								<div class="white__text">Щебень - 20 т.</div>
								<div class="white__go">Откликнулись 2</div>
							</div>
							<div class="white__row">
								<div class="white__text">Щебень - 20 т.</div>
								<div class="white__go">Откликнулись 2</div>
						...
						<div class="white__tab" v-bind:class="{ active: activeTab===2 }">
							<div class="white__row">
								<div class="white__text">Щебень - 20 т.</div>
								<div class="white__go">Откликнулись 2</div>
							</div>
						...
						<div class="white__tab" v-bind:class="{ active: activeTab===3 }">
							<div class="white__row">
								<div class="white__text">Щебень - 20 т.</div>
								<div class="white__go">Откликнулись 2</div>
							</div>
						...
						<div class="white__tab" v-bind:class="{ active: activeTab===4 }">
							<div class="white__row">
								<div class="white__text">Щебень - 20 т.</div>
								<div class="white__go">Откликнулись 2</div>
							</div>
...
export default {
	...
	created(){
		this.items.push({to:`/projects/${this.$route.params.id}`, text: this.projects[this.$route.params.id].name})
		this.project = this.projects[this.$route.params.id];
	},
	methods: {
		chageTab: function (newTab){
